...
import '../../../commons/templates/under_construction_view.dart';
...
import '../../workouts/ui/view/widgets/workout_list.dart';
...
class _HomeScreenState extends State<HomeView> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    final String greetingMessage = isMorning ? l10n.home_greeting(userName) : l10n.home_greetingnight(userName);
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          AppSizes.gapH12,
          TabsStepCustom(
            stepTabs: [WorkoutList(), UnderConstructionView(), UnderConstructionView()],
            tabsHeader: [
              Tab(child: Text(l10n.tab_my_workouts, style: TextStyles.stepTextWhite)),
              Tab(child: Text(l10n.tab_estadistics, style: TextStyles.stepTextWhite)),
              Tab(child: Text(l10n.tab_discover, style: TextStyles.stepTextWhite)),
            ],
          ),
        ],
      ),
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: [
          ...
          BottomNavigationBarItem(icon: const Icon(Icons.chair), label: l10n.tab_estadistics),
